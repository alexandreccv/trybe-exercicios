...
/**
 * 1 - Imprima no console uma mensagem de boas-vindas para a personagem acima, incluindo o nome dela. Para isso, utilize a 
 * sintaxe meuObjeto.chave. Então, o valor esperado no console é:
 */

// 2 - Insira no objeto uma nova propriedade com o nome de chave ‘recorrente’ e o valor ‘Sim’ e, em seguida, imprima o objeto 
//no console. Para isso, use a sintaxe meuObjeto['chave'] = valor. Então, o valor esperado no console é:
info['recorrente'] = 'Sim';
 ...
 * imprima os valores de cada objeto juntos, de acordo com cada uma das chaves. O valor esperado no console é:
...
/**
 * 1 - Acesse as chaves nome, sobrenome e titulo – esta encontra-se dentro da chave livrosFavoritos – e faça um console.log no 
 * seguinte formato: “O livro favorito de Julia Pessoa se chama ‘O Pior Dia de Todos’”.

2 - Adicione um novo livro favorito na chave livrosFavoritos, que é um array. Atribua a essa chave um objeto que contenha as 
