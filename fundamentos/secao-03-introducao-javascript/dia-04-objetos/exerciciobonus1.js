//Suponha que você esteja trabalhando em uma escola e precise fazer algumas atualizações no sistema. Para isso, considere 
//o seguinte código:
...
function addNewKey(obj, key, value) {
  obj[key] = value;
  // através do "obj[key]" acessamos a chave do objeto cujo valor queremos modificar. A partir daí basta atribuir o valor desejado, que na função é o terceiro parâmetro (value).
}
addNewKey(lesson2, 'turno', 'noite');
console.log(lesson2);


  // através do "objeto[chave]" acessamos a chave do objeto cujo valor queremos modificar. A partir daí basta atribuir o valor 
  //desejado, que na função é o terceiro parâmetro (valor).
...
function sizeObj(obj) { 
  ...
  // Como o "Object.keys()" devolve um array, é possível utilizar o método ".length" para obter seu tamanho
}
...
function listValues(obj) { 
  ...
  // Quando se quer recuperar as chaves, é preciso utilizar o "Object.keys()". De modo similar, para recuperar os valores do objeto em um array, utiliza-se o método "Object.values()".
}
console.log(listValues(lesson1));

///Crie um objeto de nome allLessons, que deve agrupar todas as aulas por meio do Object.assign.Cada chave desse novo objeto
//será uma aula, portanto essas chaves serão nomeadas lesson1, lesson2 e lesson3.Ao executar o comando console.log(allLessons),
...
//Crie uma função que verifique se o par chave/valor existe na função. Essa função deve possuir três parâmetros:o objeto, 
//o nome da chave e o valor dela. Por exemplo:
